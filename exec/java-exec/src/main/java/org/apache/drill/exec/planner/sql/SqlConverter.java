...
public class SqlConverter {
  ...
  private class DrillValidator extends SqlValidatorImpl {
    ...
    public void changeNamesIfTableIsTemporary(SqlIdentifier tempNode) {
  ...
  private class DrillCalciteCatalogReader extends CalciteCatalogReader {
    ...
    public boolean isTemporaryTable(final List<String> names) {
      return (mightBeTemporaryTable(names, session.getDefaultSchemaPath(), drillConfig));
    }

    public List<String> getTemporaryNames(List<String> names) {
      if (isTemporaryTable(names)) {
